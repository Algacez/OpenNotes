...
6970|real音频开放此端口
7000|木马Remote Grab开放此端口|frp默认端口
7002|使用者& 组 数据库
7003|音量定位数据库
...
7797|Propel连接器端口
7798|Propel编码器端口
8000|腾讯QQ服务器端开放此端口（一言hitokoto默认端口也是这个）
8001|VCOM通道
...
17027|外向连接
18080|frps的控制面板http端口
18443|frps的控制面板https端口
19191|木马蓝色火焰开放此端口
...
23333|mcsmanager默认web端口
23444|木马网络公牛开放此端口
23456|木马Evil FTP、Ugly FTP开放此端口
24444|mcsmanager默认守护进程端口
25565｜我的世界java版本服务器默认端口
25793|Vocaltec地址服务器
26262|K3软件-服务器
26263|K3软件客户端
26274|木马Delta开放此端口
